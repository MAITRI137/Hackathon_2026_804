...
const GROUPS: NavGroup[] = [
  {
    label: 'Overview',
    items: [
      { to: '/', label: 'Dashboard', icon: LayoutDashboard, permission: null, selfLabel: 'My Dashboard' },
      { to: '/approvals', label: 'Approval Inbox', icon: Inbox, permission: 'approval.read', badge: 'approvals' },
    ],
  },
  {
    label: 'People',
    items: [
      ...
      { to: '/contracts', label: 'Contracts', icon: FileText, permission: 'contract.read.self', selfLabel: 'My Contract' },
      { to: '/schedules', label: 'Working Schedules', icon: CalendarDays, permission: 'schedule.read' },
      { to: '/documents', label: 'Documents', icon: FolderOpen, permission: 'document.read.self', selfLabel: 'My Documents' },
    ],
  },
  {
    label: 'Time',
    items: [
      { to: '/attendance', label: 'Attendance', icon: Clock, permission: 'attendance.read.self', selfLabel: 'My Attendance' },
      { to: '/timeoff', label: 'Time Off', icon: CalendarOff, permission: 'timeoff.request.self', selfLabel: 'My Time Off' },
    ],
  },
  {
    label: 'Payroll',
    items: [
      ...
      { to: '/payslips', label: 'Payslips', icon: Receipt, permission: 'payslip.read.self', selfLabel: 'My Payslips' },
      { to: '/payroll/exceptions', label: 'Exception Centre', icon: TriangleAlert, permission: 'payrun.read', badge: 'exceptions' },
      { to: '/salary', label: 'Salary Config', icon: SlidersHorizontal, permission: 'salary.structure.read' },
